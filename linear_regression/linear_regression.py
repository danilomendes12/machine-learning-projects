...
# y = a + bx
def linear_regression_two_features(x, y, starting_a_value=1, starting_b_value=1, max_iterations=1000,
    ...
    for i in range(0, max_iterations):
        (a, b) = update_coefficients(normalized_x, y, a, b, learning_rate, sample_size)
